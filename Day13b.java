...
public class Day13b {
    public static void main(String[] args)throws Exception{
        String filename = "c:/users/lance/documents/AoC22Day13input.txt";
    ...
    Integer sum = indexList.stream().reduce(Integer::sum).get();
    ...
    int sixIndex = 0;
        ...
        if (getIntegerFromList((List) a) == 2) {
            System.out.println("The index for 2 is " + newIndex);
            twoIndex = newIndex;
        }
        if (getIntegerFromList((List) a) == 6) {
            System.out.println("The index for 6 is " + newIndex);
            sixIndex = newIndex;
        }
        newIndex++;
    }

        System.out.println("The answer to part two is " + twoIndex * sixIndex);
}
